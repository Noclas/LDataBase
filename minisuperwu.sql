USE [master]
GO
/****** Object:  Database [minisuper]    Script Date: 04/11/2017 03:18:51 p.m. ******/
...
( NAME = N'minisuper', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\minisuper.mdf' , SIZE = 4160KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'minisuper_log', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\minisuper_log.ldf' , SIZE = 1088KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
USE [minisuper]
GO
/****** Object:  StoredProcedure [dbo].[mayor_inversion]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[mayor_inversion] (@inversion int)
as
begin
	select * from dbo.SumInvent where Total_Por_Producto > @inversion
end
GO
/****** Object:  StoredProcedure [dbo].[mayor_venta]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[mayor_venta] (@var1 int)
as 
begin
	select * from dbo.DetalleDeV where producto_cant > @var1
end
GO
/****** Object:  StoredProcedure [dbo].[prodbar]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[prodbar] (@var2 int, @var3 int)
as
begin
	select * from dbo.InvenTo where cantidad < @var2 and PrecioProducto < @var3
end
GO
/****** Object:  StoredProcedure [dbo].[prove]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[prove] (@prov varchar(20))
as
begin
	select * from dbo.ProdPro where Nombre_Proveedor = @prov
end
GO
/****** Object:  StoredProcedure [dbo].[tipopag]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [dbo].[tipopag] (@tp varchar(10))
as
begin
	select * from dbo.PagoVen where Tipo_de_Pago = @tp and monto > 50
end
GO
/****** Object:  UserDefinedFunction [dbo].[fnabastecer]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create function [dbo].[fnabastecer] (@actual int, @abastecimiento int)		-- verificara la cantidad de productos acutales en el primer valor y sumara 
returns int
as
begin
...
GO
/****** Object:  Table [dbo].[cajero]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[d_orden_c]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[detalle_of]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[detalle_v]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[inventario]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[movimiento_e]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[movimiento_s]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[oferta]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[orden_c]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[pagos]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[producto]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[proveedor]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ventas]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[DetalleDeV]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[InvenTo]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[PagoVen]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ProdPro]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[SumInvent]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[Cambio_D_Inventario]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create trigger [dbo].[Cambio_D_Inventario]
on [dbo].[inventario]
after update 
as
begin
...
END
GO
/****** Object:  Trigger [dbo].[Prod]    Script Date: 04/11/2017 03:18:51 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
